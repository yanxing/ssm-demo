			...
			<td valign="top"><table width="100%" style="height: 590px"
					...
					<tr>
						...
						<td width="50%" valign="bottom"><table width="100%"
								...
								<tr>
									<td width="4%">&nbsp;</td>
									<td width="96%" height="38"><span class="login_txt_bt">学生管理系统
									</span></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
														...
														<table width="100%" border="0"
															...
															<tr>
																...
																<td height="30"><input type="text"
																	name="admin.username" id="username" size="20"
															...
															<tr>
																...
																<td height="30" align="left"><input type="password"
																	size="20" name="admin.password" id="password"
