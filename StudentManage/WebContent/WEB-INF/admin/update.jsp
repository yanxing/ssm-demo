...
<body>
	<form id="Form" method="post"
		action="admin/updateStudentAction?number=<s:property value="list.get(1)"/>">
		<p>
			学&nbsp;&nbsp;号：&nbsp;&nbsp;&nbsp;<input type="text"
			...
			<br /> 出生日期： <input type="text" name="birthday" id="datepicker" readonly="readonly"
			...
			班&nbsp;&nbsp;&nbsp;级：&nbsp;&nbsp;<select name="name"
				id="professionId">
				<option selected="selected"><s:property value="list.get(6)" /></option>
				<s:iterator value="list1" id="classGrade">
					
					<s:if test="%{list.get(6)!=#classGrade.name}">
