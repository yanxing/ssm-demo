...
public class UtilHibernateDaoSupport extends HibernateDaoSupport {
	/**
	 * 使用hql语句进行分页查询
	 * 
	 * @param hql
	...
	public int getAllRowCount(String hql) {// 返回记录数,不带参数
		return getHibernateTemplate().find(hql).size();
	}

	public int getAllRowCount(String hql, Object value) {// 返回记录数,带一个参数
		return getHibernateTemplate().find(hql, value).size();
	}

	public int getAllRowCount(String hql, Object[] values) {// 返回记录数，带一个数组参数
